subroutine cpaDOS(dos,dos2,spec,w,tot,e,eps)
!--------------------------------------------------------------------------
...
real(kind=8), intent(out) :: dos(sec+1), dos2(ntype,sec), spec(jsz)
...
1005 format("Spectral function for energy ",F10.6,":",/,904F10.6)
